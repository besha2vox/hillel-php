...
class App
{
    ...
    public function record(string $fileName, string $text, string $priority)
    {
    ...
    public function done(string $fileName, string $id)
    {
        if(!isset($fileName)) {
            throw new Exception(
    ...
    public function remove(string $fileName, string $id)
    {
        if(!isset($fileName)) {
            throw new Exception(
